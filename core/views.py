...
from .models import PressRelease, HomeCard, CitizenshipBadge, ORIGIN_CHOICES, TabSettings, EditableElement
...
def citizenship(request):
    ...
    context.update(_tab_context("citizenship", "Citizenship | Nomashae"))
